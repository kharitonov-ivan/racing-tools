...
def main():
    ...
    logging.info(f"Arguments: input_video='{args.input_video}', rows={args.rows}, cols={args.cols}, size={args.size}, sample_interval={args.sample_interval}, threads={args.threads}, output='{args.output}'")
    ...
    ret_rat, mtx_rat, dist_rat, rvecs_rat, tvecs_rat = cv2.calibrateCamera(objpoints, imgpoints, img_size, None, None, flags=flags_rational)
