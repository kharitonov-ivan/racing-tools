...
- **Track Map**: Live position on the track map (requires GeoJSON geometry files).
...
- `geometry/centerline.geojson`: Track centerline (optional, computed if missing)
- `geometry/bestline.geojson`: Optimal racing line (optional)
